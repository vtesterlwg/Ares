...
public final class ProfileService implements AresService, Listener {
    ...
    @Getter public Set<AresProfile> profiles;
    @Getter public final MenuHandler menuHandler;
    @Getter public final IgnoreHandler ignoreHandler;
    @Getter public final MessageHandler messageHandler;
